...
export const Header: React.FC<HeaderProps> = ({
  ...
  const dueBills = apBills.filter(b => b.status === 'Unpaid');
    ...
    <header id="app-header" className="h-16 bg-white border-b border-stone-200 sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="py-1">
                      ...
                      {matchingEmployees.map(emp => (
                        <button
                          ...
                          className="w-full text-left px-2 py-1.5 hover:bg-stone-50 rounded flex items-center justify-between"
                        >
                          <div>
        ...
        <button
          ...
          className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-stone-700 bg-stone-100 hover:bg-stone-200 rounded-lg border border-stone-200 transition-colors"
          title="Export complete Phase-1 JSON system of record"
        >
        ...
        <button
          ...
          type="button"
          onClick={handleReset}
          className="p-1.5 sm:px-2.5 sm:py-1.5 text-xs font-medium text-stone-600 hover:text-stone-900 hover:bg-stone-100 rounded-lg border border-stone-200 transition-colors flex items-center gap-1"
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-stone-100 text-left transition-colors"
          >
            ...
            >
              ...
              <div className="py-1">
                <button
                  ...
                  className="w-full text-left px-2 py-1.5 hover:bg-stone-50 rounded text-stone-700 font-medium"
                >
