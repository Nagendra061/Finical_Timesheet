 ...
 * Renders weekly timesheet management, day-by-day hours logging, and financial approval workflow.
 *
...
export const TimesheetsView = () => {
  ...
  const handlePlacementChange = (pId) => {
  ...
  const handleDailyHourChange = (index, field, value) => {
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border border-stone-200 shadow-xs overflow-hidden">
        <TimesheetTable
          ...
          onApprove={setApprovingTimesheet}
          onReject={setRejectingTimesheet}
          onView={setDetailTimesheet}
            ...
            return (
              <div className="space-y-4 text-xs">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-7 gap-1.5 text-center">
                    {(detailTimesheet.dailyHours || detailTimesheet.dailyEntries || []).map((d, i) => (
