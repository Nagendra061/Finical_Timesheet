...
import { RevenueByClientCard } from '../reports/RevenueByClientCard';
import {
  formatCurrency,
  formatDate,
  formatPercent,
 ...
 * Renders comprehensive financial, margin, profitability, and operational reports with CSV export.
 *
...
export const ReportsView = () => {
  ...
  const [activeReport, setActiveReport] = useState('employee-profitability');
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border border-stone-200 shadow-xs overflow-hidden">
        ...
        {activeReport === 'revenue-by-client' && (
          <RevenueByClientCard items={revenueByClientData} />
        )}
